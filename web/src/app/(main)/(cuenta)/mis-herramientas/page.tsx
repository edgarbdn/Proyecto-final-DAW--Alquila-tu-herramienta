            ...
            return (
              <div key={h.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  >
                    {toggling === h.id ? "..." : h.disponible ? "Desactivar" : "Activar"}
                  </button>
                  <button
                    onClick={() => handleEliminar(h.id)}
                    disabled={eliminando === h.id}
                    className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-gray-50 text-gray-400 hover:bg-red-50 hover:text-red-500 transition-colors disabled:opacity-50"
                  >
